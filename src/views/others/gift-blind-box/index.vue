  ...
  <CommonPage>
    <div class="mb-20 flex">
      <n-card class="w-100%">
        <n-row>
          <n-col :span="8">
            <n-statistic label="礼物价格" :value="statisticData.price">
              <template #prefix>
          ...
          <n-col :span="8">
            <n-statistic label="盲盒价格" :value="statisticData.original_price">
              <template #prefix>
          ...
          <n-col :span="8">
            <n-statistic label="盲盒盈利" :value="statisticData.profit_price">
              <template #prefix>
...
const tableColumns = ref([
  ...
  { title: '盲盒价格', key: 'original_price', minWidth: 120 },
  { title: '盈利金额', key: 'profit_price', minWidth: 120 },
